...
R is highly customizable, so that your life is a lot easier if you use your own copy rather than a shared copy on a university computer. To install it on your computer, you can follow these detailed instructions for \href{http://derekogle.com/IFAR/supplements/installations/InstallRWin.html}{Windows} and \href{http://derekogle.com/IFAR/supplements/installations/InstallRMac.html}{Mac OS}. Make sure to install both R and RStudio.
...
\begin{verbatim}
## also installing the dependencies 'mathjaxr', 'pbapply', 'metafor', 'CompQuadForm'
\end{verbatim}
...
\KeywordTok{forest}\NormalTok{(meta_analysis, }\DataTypeTok{sortvar =} \OperatorTok{-}\NormalTok{TE, }\DataTypeTok{text.fixed =} \StringTok{"Fixed effects: overall estimate"}\NormalTok{, }
       \DataTypeTok{text.random =} \StringTok{"Random effects: overall estimate"}\NormalTok{, }\DataTypeTok{leftcols =} \KeywordTok{c}\NormalTok{(}\StringTok{"studlab"}\NormalTok{, }\StringTok{"n.e"}\NormalTok{), }\DataTypeTok{leftlabs =} \KeywordTok{c}\NormalTok{(}\StringTok{"Lab"}\NormalTok{, }\StringTok{"N"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
## Number of observations: o = 7228
## 
##                          OR           95%-CI     z  p-value
## Common effect model  2.2088 [1.9935; 2.4473] 15.15 < 0.0001
...
\tightlist
\item
  The \href{https://github.com/awesomedata/awesome-public-datasets}{awesomedata collection} has a huge range of links to datasets across all kinds of domains - from Museums to prostate cancer. Worth exploring.
\item
