...
```{r, fig.cap="Scatterplot relating social trust to life satisfaction", message=FALSE}
...
```{r, fig.cap='Scatterplot with added regression line ("line of best fit")', message=FALSE}
...
```{r, fig.cap="Scatterplot with scaled variables (z-scores)", message = FALSE}
...
```{r fig.cap='Multiple regression model to predict Tory 2019 vote share', message=FALSE}
