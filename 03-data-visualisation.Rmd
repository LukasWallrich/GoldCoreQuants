...
```{r, fig.cap="A simple ggplot example", message=FALSE}
...
```{r img-dummy-coding, echo=FALSE, fig.cap='Same data, two messages (Source: <a href="https://www.infoworld.com/article/3088166/why-how-to-lie-with-statistics-did-us-a-disservice.html">infoworld.com</a>)'}
