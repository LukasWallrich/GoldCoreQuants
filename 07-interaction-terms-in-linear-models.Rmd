...
```{r fig.cap='Simple interaction plot - note that lines are not parallel', message=FALSE, results='markup'}
...
```{r fig.cap='interact_plot shows different slope for men and women', message=FALSE, results='markup'}
pacman::p_load(interactions)
...
```{r fig.cap='Johnson-Neyman plot shows regions of significance', results='markup'}
